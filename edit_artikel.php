...
$artikelId = $_GET['id'];
$sql = "SELECT * FROM artikel where artikel.idartikel = $artikelId";
$queryArtikel = mysqli_query($koneksi, $sql);
$artikelData = mysqli_fetch_assoc($queryArtikel);
?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <div class="card-body">
                                <form action="update.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="judul" name="judul" value="<?= $artikelData['judul'] ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="subjudul">Subjudul:</label>
                                        <input type="text" class="form-control" id="subtitle" name="subtitle" value="<?= $artikelData['subtitle'] ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="konten">Konten:</label>
                                        <textarea class="form-control" id="konten" name="konten" rows="10"><?= $artikelData['content'] ?></textarea>
                                    </div>
                              ...
                              <div class="form-group">
                                ...
                                <p class="text-muted">Ukuran gambar maksimal 1 MB (jpg, jpeg, png)<br>
                                Gambar sebelumnya : <?= $artikelData['file'] ?></p>
                            </div>
