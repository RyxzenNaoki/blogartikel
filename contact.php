        ...
        <div class="row gy-4">
          ...
          <div class="col-md-4">
            <div class="info-item">
              ...
              <h3>Address</h3>
              <address>Perum. Griya Permata Alam, E-21, Ngijo, Karangploso</address>
            </div>
          </div><!-- End Info Item -->
          ...
          <div class="col-md-4">
            <div class="info-item info-item-borders">
              ...
              <h3>Phone Number</h3>
              <p><a href="tel:+6281333376100">+62 81333376100</a></p>
            </div>
          </div><!-- End Info Item -->
          ...
          <div class="col-md-4">
            <div class="info-item">
              ...
              <h3>Email</h3>
              <p><a href="mailto:220605110113@student.uin-malang.ac.id">220605110113@student.uin-malang.ac.id</a></p>
            </div>
          </div><!-- End Info Item -->
